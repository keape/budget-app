...
function Transazioni() {
  ...
  return (
    <div className="theme-container p-6 max-w-4xl mx-auto">
      ...
      {/* Link ai Filtri e Gestisci Categorie */}
      <div className="text-center mb-6 space-y-3">
        ...
        <button
          ...
          className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-md hover:shadow-lg flex items-center space-x-2 mx-auto"
        >
          <span>⚙️</span>
      ...
      <div className="mb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          ...
          <button
            type="button"
            className="bg-red-500 hover:bg-red-600 text-white text-xl font-bold py-6 px-8 rounded-xl shadow-lg transform transition-all duration-200 hover:scale-105 hover:shadow-xl flex items-center justify-center space-x-3"
            onClick={() => {
          ...
          {/* Bottone Aggiungi Entrata */}
          <button
            type="button"
            className="bg-green-500 hover:bg-green-600 text-white text-xl font-bold py-6 px-8 rounded-xl shadow-lg transform transition-all duration-200 hover:scale-105 hover:shadow-xl flex items-center justify-center space-x-3"
            onClick={() => {
              setModalitaTransazione('una_tantum');
              setTipo('entrata');
            }}
          >
            <span>💰</span>
            <span>Aggiungi Entrata</span>
          </button>
        </div>
        
        {/* Link per funzioni avanzate */}
        <div className="text-center mt-6">
          <button
            type="button"
            className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm underline font-medium"
            onClick={() => setModalitaTransazione('periodica')}
          >
            🔄 Gestisci abbonamenti e transazioni ricorrenti
          </button>
          ...
          {modalitaTransazione === 'periodica' && (
            <div className="mt-2">
              <button
                type="button"
                className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 text-sm underline font-medium"
                onClick={() => setModalitaTransazione('archivio')}
              >
                📋 Vedi archivio transazioni periodiche
              </button>
            </div>
          )}
        </div>
        ...
        <form onSubmit={aggiungiTransazione} className="space-y-6">
          ...
          <div className="text-center mb-6">
            <h2 className={`text-2xl font-bold ${
              ...
              {tipo === 'spesa' ? '💸 Aggiungi Spesa' : '💰 Aggiungi Entrata'}
            </h2>
            <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
              Inserisci i dettagli della tua {tipo === 'spesa' ? 'spesa' : 'entrata'}
            </p>
          </div>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            {isLoading 
              ...
              : modalitaTransazione === 'periodica' 
                ? (transazioneInModifica ? 'Salva modifiche' : 'Crea abbonamento') 
                : tipo === 'spesa'
                  ? '💸 Salva Spesa'
                  : '💰 Salva Entrata'
            }
