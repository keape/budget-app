  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
            Budget365 è la tua soluzione completa per la gestione delle finanze personali.
      ...
      <div
        ...
        onClick={() => window.open('https://various-sushi-3f4.notion.site/Budget365-Privacy-Policy-2e372b8820f88038a92ef83fedfd03d7', '_blank')}
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center text-indigo-600 dark:text-indigo-400 font-medium">
            <span className="mr-2">Leggi informativa</span>
            <span>↗️</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          Il tuo feedback è prezioso per migliorare continuamente Budget365.
        </p>
