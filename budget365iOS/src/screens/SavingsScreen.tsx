...
const TAB_LABELS_BY_LANG: Record<'it' | 'en' | 'es', Record<ActiveTab, string>> = {
  it: { mese: 'Mese', piano: 'Piano', portfolio: 'Portfolio' },
  en: { mese: 'Month', piano: 'Plan', portfolio: 'Portfolio' },
  es: { mese: 'Mes', piano: 'Plan', portfolio: 'Portfolio' },
};
...
const STRINGS = {
  ...
  es: {
    errore: 'Error',
    futureMonth: 'No se pueden añadir asignaciones para meses futuros',
    invalidAmount: 'Introduce un importe válido mayor que 0',
    qtyMustBeGreater: 'La cantidad debe ser mayor que 0',
    priceMustBeGreater: 'El precio debe ser mayor que 0',
    couldNotPrepareMonth: 'No se pudo preparar el registro del mes',
    couldNotGetMonthId: 'No se pudo obtener el ID del mes',
    couldNotAddAllocation: 'No se pudo añadir la asignación',
    networkError: 'Error de red',
    elimina: 'Eliminar',
    deleteAllocationMsg: '¿Eliminar esta asignación?',
    annulla: 'Cancelar',
    couldNotDeleteAllocation: 'No se pudo eliminar la asignación.',
    qtyRange: (max: number) => `La cantidad debe estar entre 0 y ${max}`,
    invalidSalePrice: 'Introduce un precio de venta válido',
    couldNotSaveSale: 'No se pudo guardar la venta',
    deleteSaleTitle: 'Eliminar venta',
    deleteSaleMsg: '¿Eliminar este registro de venta?',
    couldNotDeleteSale: 'No se pudo eliminar la venta.',
    invalidPercentage: 'Introduce un porcentaje válido',
    couldNotSavePlan: 'No se pudo guardar el plan.',
    invalidAmountGeneric: 'Introduce un importe válido',
    couldNotSaveGoal: 'No se pudo guardar el objetivo de ahorro.',
    noDataMonth: 'No hay datos para este mes',
    savingsEyebrow: (month: string, year: number) => `Ahorros · ${month} ${year}`,
    income: 'INGRESOS',
    expenses: 'GASTOS',
    allocated: 'Asignado',
    invested: 'INVERTIDO',
    ...
    noAllocationsYet: 'Aún no hay asignaciones',
    pctOfSavings: (pct: string) => `${pct}% de los ahorros`,
    addAllocation: '+ Añadir asignación',
    salesTitle: 'VENTAS',
    proceedsSuffix: (amt: string) => `${amt} de ingresos`,
    monthView: 'Mes',
    yearView: 'Año',
    annualSavingsGoal: 'OBJETIVO ANUAL DE AHORRO',
    monthlySavingsGoal: 'OBJETIVO MENSUAL DE AHORRO',
    annualGoal: 'Objetivo anual',
    monthlyGoal: 'Objetivo mensual',
    cancel: 'Cancelar',
    save: 'Guardar',
    edit: 'Editar',
    monthsPlanned: (n: number) => `${n} mes${n !== 1 ? 'es' : ''} planificado${n !== 1 ? 's' : ''}`,
    savedThisYear: 'AHORRADO ESTE AÑO',
    savedThisMonth: 'AHORRADO ESTE MES',
    setSavingsGoal: '+ Establecer objetivo de ahorro',
    noMonthlyGoals: (year: number) => `No hay objetivos mensuales establecidos para ${year}.\nCambia a la vista Mes para añadirlos.`,
    yearSavingsEyebrow: (year: number) => `Ahorros anuales · ${year}`,
    instrumentsCount: (n: number) => `${n} instrumentos`,
    targetAllocation: 'ASIGNACIÓN OBJETIVO',
    noPlanSet: 'Ningún plan establecido',
    actualPct: (pct: string) => `Real ${pct}%`,
    addInstrument: '+ Añadir instrumento',
    portfolioValue: 'Valor del portfolio',
    investedPrefix: (amt: string) => `Invertido ${amt}`,
    noInvestments: 'No hay inversiones registradas',
    holdings: 'POSICIONES',
    positionsCount: (n: number) => `${n} posiciones`,
    closed: 'CERRADA',
    realizedPrefix: (amt: string) => `Realizado ${amt}`,
    sell: 'Vender',
    investedLabel: 'Invertido',
    currentValue: 'Valor actual',
    unrealizedPnL: 'Plusvalía no realizada',
    realizedPnL: 'Plusvalía realizada',
    addAllocationTitle: 'Añadir asignación',
    searchInstrumentAmounts: 'Buscar instrumento (VWCE, BTC, …)',
    whatToEnter: '¿Qué quieres introducir?',
    amount: 'Importe',
    quantity: 'Cantidad',
    autoSuffix: ' (auto)',
    price: 'Precio',
    fetching: 'Obteniendo…',
    addInstrumentToPlan: 'Añadir instrumento al plan',
    searchInstrumentGeneric: 'Buscar instrumento…',
    targetPctLabel: '% Objetivo',
    egThirty: 'ej. 30',
    monthlyGoalOptional: 'Objetivo mensual (opcional)',
    egFiveHundred: 'ej. 500',
    sellAsset: 'Vender activo',
    availableColon: (qty: string) => `Disponible: ×${qty}`,
    avgCost: (val: string) => `precio medio ${val}`,
    priceAtSale: 'Precio de venta',
    proceedsLabel: 'Ingreso',
    costBasis: 'Coste base (PMC)',
    estPnL: 'Plusvalía estimada',
