...
const STRINGS = {
  ...
  es: {
    ...
    loadErrorTitle: 'Error',
    loadErrorMsg: 'No se pudieron cargar los datos del presupuesto.',
    sessionExpiredTitle: 'Sesión caducada',
    sessionExpiredMsg: 'Tu sesión no es válida. Inicia sesión de nuevo.',
    copySuccessTitle: 'Éxito',
    copySuccessMsg: (monthName: string, year: number) => `Valores copiados de ${monthName} ${year}`,
    copyErrorTitle: 'Error',
    copyErrorMsg: 'No se pudieron copiar los valores del mes anterior',
    copyYearSuccessTitle: 'Éxito',
    copyYearSuccessMsg: (activeTab: 'expenses' | 'income', fromYear: number, toYear: number) => `Presupuestos de ${activeTab === 'expenses' ? 'gastos' : 'ingresos'} copiados de ${fromYear} a ${toYear}`,
    copyYearErrorTitle: 'Error',
    copyYearErrorMsg: 'No se pudieron copiar los valores del año anterior',
    selectMonth: 'Seleccionar mes',
    selectYear: 'Seleccionar año',
    close: 'Cerrar',
    nameRequiredTitle: 'Error',
    nameRequiredMsg: 'Introduce un nombre para la categoría',
    categoryExistsTitle: 'Error',
    categoryExistsMsg: 'La categoría ya existe',
    invalidNameTitle: 'Error',
    invalidNameMsg: 'Introduce un nombre válido',
    categoryNameExistsTitle: 'Error',
    categoryNameExistsMsg: 'El nombre de la categoría ya existe',
    renameErrorTitle: 'Error',
    renameErrorMsg: 'No se pudo renombrar la categoría globalmente. Inténtalo de nuevo.',
    deleteCategoryTitle: 'Eliminar categoría',
    deleteCategoryMsg: (catName: string) => `¿Seguro que quieres eliminar "${catName}"? Se eliminará de TODO el historial.`,
    cancel: 'Cancelar',
    deleteEverywhere: 'Eliminar en todas partes',
    deleteErrorTitle: 'Error',
    deleteErrorMsg: 'No se pudo eliminar la categoría globalmente.',
    archiveErrorTitle: 'Error',
    archiveErrorMsg: 'No se pudo archivar la categoría.',
    restoreErrorTitle: 'Error',
    restoreErrorMsg: 'No se pudo restaurar la categoría.',
    heroEyebrowExpense: 'PRESUPUESTO DE GASTOS',
    heroEyebrowIncome: 'OBJETIVOS DE INGRESOS',
    actual: 'ACTUAL',
    earned: 'GANADO',
    used: 'USADO',
    copyFromMonth: (monthName: string) => `Copiar valores de ${monthName}`,
    copyFromYear: (typeLabel: string, year: number) => `Copiar ${typeLabel} de ${year}`,
    expensesLower: 'los gastos',
    incomeLower: 'los ingresos',
    expensesTab: 'Gastos',
    incomeTab: 'Ingresos (Objetivos)',
    addCategoryBtn: '+ Añadir nueva categoría',
    actualColon: 'Actual:',
    noCategories: 'No se encontraron categorías.',
    archivedCategoriesTitle: 'Categorías archivadas',
    restoreBtn: 'Restaurar',
    modifyCategoryTitle: 'Modificar categoría',
    chooseIconTitle: 'Elegir icono',
    customIconPlaceholder: 'Buscar emoji (ej. sol, corazón)...',
    orChooseBelow: 'o elige aquí abajo',
    emojiResultsCount: 'resultados',
    renameSubtitle: (catName: string) => `Renombrar "${catName}" a:`,
    newNamePlaceholder: 'Nuevo nombre...',
    renameBtn: 'Renombrar',
    newCategoryTitle: 'Nueva categoría',
    newCategorySubtitle: (typeLabel: string) => `Introduce el nombre de la categoría para ${typeLabel}`,
    categoryPlaceholder: 'ej. Vacaciones, Aficiones',
    addBtn: 'Añadir',
    saving: 'Guardando...',
    done: 'Hecho',
  },
