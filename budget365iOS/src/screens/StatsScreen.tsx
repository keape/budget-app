...
const STRINGS = {
    ...
    es: {
        ...
        exceededGoal: 'Objetivo superado',
        belowGoal: 'Por debajo del objetivo',
        monthlyTrend: 'Tendencia mensual · toca una barra para ver ese mes',
        distribution: (typeMode: 'spese' | 'entrate') => `Distribución de ${typeMode === 'spese' ? 'gastos' : 'ingresos'}`,
        moreCategories: (n: number) => `+${n} más`,
        noData: 'No hay datos disponibles para este periodo.',
        over: 'sobre',
        remaining: 'restantes',
        tapToView: 'Toca para ver las transacciones →',
